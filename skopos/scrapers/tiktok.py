...
Scrapes public TikTok profiles by parsing the __UNIVERSAL_DATA_FOR_REHYDRATION__
JSON blob embedded in the profile page.

Features:
- No authentication required
- Reuses one httpx client, with browser-like headers per request
- Extracts follower/like counts, bio and email
- May hit CAPTCHAs depending on region or IP; a proxy usually clears it
"""
